...
public class Loginpage {
	...
	public void login_with_valid_username_password(String username, String password, String role, SoftAssert Assert) throws Throwable {
		...
		Assert.assertEquals(currenturl, "https://ecollabdds.ehospital.nic.in/management/show", "Fail: Login_with_valid_username_password");
		Assert.assertTrue(userAndRole.getText().contains(role), "Role displayed on default page is incorrect. ");
		Assert.assertTrue(userAndRole.getText().contains(username), "Username displayed on default page is incorrect. ");
