...
public class Admin_Default_Page {
	...
	@FindBy(xpath = "/html/body/div[1]/div/p/button[3]")
	...
	public void Admin_myProfile_button(SoftAssert Assert) {
	    ...
	    Assert.assertEquals(myProfileIcon.getAttribute("title"), "My Profile","Failed: Admin_myProfile_Button, title test fail ,");
		myProfileIcon.click();
		myProfileIcon.isSelected();
	...
	public void Admin_Logout_Button(SoftAssert Assert) {
	    ...
	    Assert.assertEquals(logoutIcon.getAttribute("title"), "Logout","Failed:Admin_Logout_Button, title test fail ,");
	    //logoutIcon.click();
	}
